...
<head>
    ...
    <link rel="shortcut icon" href="assets/ico/Homemade_Monogram.png">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        ...
                        <span class="li-social">
                                <a href="https://www.linkedin.com/in/rrost"><i class="fa fa-linkedin"></i></a>
                                <a href="https://github.com/rrost11"><i class="fa fa-github"></i></a> 
                                <a href="https://twitter.com/rachelrost"><i class="fa fa-twitter"></i></a> 
                                <a href="tel:7137055559"><i class="fa fa-phone"></i></a>
                            </span>
                    </li>
                </ul>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 text">
                        <h1><strong>Contact Rachel</strong></h1>
